        ...
        <>
            <form className="login-form" onSubmit={handlerSubmit}>
                ...
                <div className="input-div pass">
                    ...
                    <div className="div">
                        <input type={passwordShown ? "text" : "password"} placeholder="Password" className="input" value={pass}/>
        ...
        <>
            <form className="login-form" onSubmit={handlerSubmit}>
                ...
                <div className="input-div-name one">
                    ...
                    <div className="ldiv">
                        <input type="text" placeholder="Last Name" className="input" value={lname}/>
                    </div>
                </div>
                <div className="input-div one">
                    <i className="i">
                    ...
                    <div className="div">
                        <input type="phone" placeholder="Phone" className="input" value={pass}/>
                    </div>
                </div>
                <div className="input-div pass">
                    <i className="i">
