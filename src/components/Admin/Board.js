...
const Broad = (props) => {
  ...
  return (
    <>
      <div className="relative w-[70%] h-[80%] overflow-x-auto shadow-md sm:rounded-[20px] left-[80px] mt-12">
        ...
        <nav
          class=" relative items-center justify-between top-[33rem] pb-4 px-[45%] "
